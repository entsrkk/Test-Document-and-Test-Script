...
${GOOGLE_USERNAME}         644259031@webmail.npru.ac.th
${GOOGLE_PASSWORD}         034561568za

${BLOG_TITLE}    การใช้ Figma ในการออกแบบ UX/UI
${BLOG_TITLE_EDTE}    The Role and Workflow of a Business Analyst v.2
...
${ALERT_TIPS_2}    The article cover will automatically choose when you're upload the first image (The image url will not be choose as article cover)
